...
import { deleteDepartment, fetchDepartment } from "../../redux/actions/departmentAction";
...
const Department = () => {
  ...
  const handleEdit = (department) => {
    navigate("/admin/dashboard/add-new-department", { state: { department } });
  };
  ...
  const generatePDF = () => {
    ...
    const data = departments.map((dept, index) => [index + 1, dept.name]);
